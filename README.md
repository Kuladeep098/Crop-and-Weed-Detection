...
# CROPWEEDDETECTION_TKuladeep_USC_UCT
...
2 months ( June -17 to August 17)



Executive Summary
This report provides details of the Industrial Internship provided by Ybi foundation and The IoT Academy in collaboration with Industrial Partner UniConverge Technologies Pvt Ltd (UCT).
This internship was focused on a project/problem statement provided by UCT. We had to finish the project including the report in 2 Months’ time.
...
1. Preface
Summary of the whole 2 Months’ work.
...
2.2About Ybi foundation
Ybi foundation along with The IoT Academy and in association with Uniconverge technologies has facilitated the smooth execution of the complete internship process.
